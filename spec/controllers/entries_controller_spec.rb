...
describe EntriesController do
  ...
  let(:valid_attributes) { { "day" => "2013-07-03" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved entry as @entry" do
        ...
        post :create, {:entry => { "day" => "invalid value" }}, valid_session
        assigns(:entry).should be_a_new(Entry)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested entry" do
        ...
        Entry.any_instance.should_receive(:update_attributes).with({ "day" => "2013-07-03" })
        put :update, {:id => entry.to_param, :entry => { "day" => "2013-07-03" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the entry as @entry" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Entry.any_instance.stub(:save).and_return(false)
        put :update, {:id => entry.to_param, :entry => { "day" => "invalid value" }}, valid_session
        assigns(:entry).should eq(entry)
      end
