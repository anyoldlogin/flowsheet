...
describe CoversController do
  ...
  let(:valid_attributes) { { "cover_date" => "2013-07-06" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved cover as @cover" do
        ...
        post :create, {:cover => { "cover_date" => "invalid value" }}, valid_session
        assigns(:cover).should be_a_new(Cover)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested cover" do
        ...
        Cover.any_instance.should_receive(:update_attributes).with({ "cover_date" => "2013-07-06" })
        put :update, {:id => cover.to_param, :cover => { "cover_date" => "2013-07-06" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the cover as @cover" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Cover.any_instance.stub(:save).and_return(false)
        put :update, {:id => cover.to_param, :cover => { "cover_date" => "invalid value" }}, valid_session
        assigns(:cover).should eq(cover)
      end
